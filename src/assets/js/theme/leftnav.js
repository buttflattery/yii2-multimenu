...
$.multimenu.leftSideBar = {
    ...
    setMenuHeight: function (isFirstTime) {
        if (typeof $.fn.slimScroll != 'undefined') {
            ...
            var configs = $.multimenu.options.leftSideBar;
    ...
    checkStatuForResize: function (firstTime) {
        ...
        if (width < $.multimenu.options.leftSideBar.breakpointWidth) {
...
$(document).ready(function(){
    $.multimenu.leftSideBar.activate();
    $.multimenu.navbar.activate();
    $.multimenu.browser.activate();
});